...
declare -a Setting__=(
	...
	"night_light__temperature:	/org/cinnamon/settings-daemon/plugins/color/plugins/color/night-light-temperature;u"
	"power__display_sleep_ac:	/org/cinnamon/settings-daemon/plugins/color/plugins/power/sleep-display-ac"
